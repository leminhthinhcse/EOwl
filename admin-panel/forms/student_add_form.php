<fieldset>
    <div class="form-group">
        <label for="user_name">Name *</label>
          <input type="text" name="user_name" value="<?php echo $edit ? $student['user_name'] : ''; ?>" placeholder="Name" class="form-control" id = "user_name" >
    </div>

    <div class="form-group">
        <label for="user_name">Email *</label>
          <input type="email" name="user_email" value="<?php echo $edit ? $student['user_email'] : ''; ?>" placeholder="example@gmail.com" class="form-control" id="user_email">
    </div>

    <div class="form-group">
        <label for="user_pass">Password *</label>
          <input type="password" name="user_pass" value="<?php echo $edit ? $student['user_pass'] : ''; ?>" placeholder="Password" class="form-control" id="user_pass">
    </div> 

    <div class="form-group">
        <label for="student_school">School</label>
        <input type="text" name="student_school" value="<?php echo $edit ? $student['student_school'] : ''; ?>" placeholder="School" class="form-control" id="student_school">
    </div> 

    <div class="form-group">
        <label for="student_address">Address</label>
          <textarea name="student_address" placeholder="Address" class="form-control" id="student_address"><?php echo ($edit)? $student['student_address'] : ''; ?></textarea>
    </div>
    ...
    <div class="form-group">
        <img src="<?php echo $edit ? $upload_dir.$student['user_img'] : ''; ?>" height="70" width="70">
        <input type="hidden" name="user_img" value="<?php echo $edit ? $student['user_img'] : ''; ?>">
