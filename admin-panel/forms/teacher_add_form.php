<fieldset>
    <div class="form-group">
        <label for="user_name">Name *</label>
          <input type="text" name="user_name" value="<?php echo $edit ? $teacher['user_name'] : ''; ?>" placeholder="Name" class="form-control" id = "user_name" >
    </div> 

    <div class="form-group">
        <label for="user_name">Email *</label>
          <input type="email" name="user_email" value="<?php echo $edit ? $teacher['user_email'] : ''; ?>" placeholder="Email" class="form-control" id = "user_email" >
    </div> 

    <div class="form-group">
        <label for="user_pass">Password *</label>
          <input type="password" name="user_pass" value="<?php echo $edit ? $teacher['user_pass'] : ''; ?>" placeholder="Password" class="form-control" id = "user_pass" >
    </div>
        ...
        <label>Assigned By </label>
            <select id="assigned_by" name="assigned_by" class="form-control selectpicker" required>
                ...
                foreach ($admin as $opt) {
                    if ($edit && $opt['admin_id'] == $teacher['assigned_by']) {
                        $sel = "selected";
                    } else {
                        $sel = "";
                    }
    ...
    <div class="form-group">
        <img src="<?php echo $edit ? $upload_dir.$teacher['user_img'] : ''; ?>" height="70" width="70">
        <input type="hidden" name="user_img" value="<?php echo $edit ? $teacher['user_img'] : ''; ?>">
    ...
    $(document).ready(function(){
        ...
        $("#btn-save").click(function(e){
            ...
            if(assigned_by == ''){
                ...
                $('teacher_form').unbind('submit').submit();
            }
        });
    });
    </script>
