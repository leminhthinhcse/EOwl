<fieldset>
    <div class="form-group">
        <label for="user_name">Name *</label>
          <input type="text" name="user_name" value="<?php echo $edit ? $teacher['user_name'] : ''; ?>" placeholder="First Name" class="form-control" id = "user_name" >
    </div> 
    ...
    <div class="form-group">
        <img src="<?php echo $upload_dir.$teacher['user_img'] ?>" height="70" width="70">
