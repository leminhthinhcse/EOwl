...
<head>
	...
	<script type="text/javascript">
		...
		window.Muse.assets = {
			"required": [ "museutils.js", "museconfig.js", "webpro.js", "musewpslideshow.js", "jquery.museoverlay.js", "touchswipe.js", "jquery.watch.js", "jquery.musemenu.js", "require.js", "thi.css" ],
			"outOfDate": []
		};
	</script>
	...
	<link rel="stylesheet" type="text/css" href="css/thi.css?crc=3827885569" id="pagesheet"/>
	<!-- JS includes -->
	<!--[if lt IE 9]>
...
?>
			<div class="rounded-corners clearfix colelem" id="u7454">
				<!-- group -->
				<div class="clearfix grpelem" id="u7494-4">
					<!-- content -->
					<p><?php echo $data['exam_name']?> - <?php echo $data['subject']?></p>
				</div>
			</div>
			<div class="rgba-background rounded-corners clearfix colelem" id="u7451">
				<!-- column -->
				<div class="clearfix colelem" id="u7497-4">
					<!-- content -->
					<p>MÔN: <?php echo $data['subject']?></p>
				</div>
				<div class="clearfix colelem" id="u7500-4">
					<!-- content -->
					<p><?php echo $data['exam_name']?> - <?php echo $data['subject']?></p>
				</div>
				<div class="clearfix colelem" id="u7503-4">
					<!-- content -->
					<p>Thời gian làm bài: <?php echo $data['time']?> phút</p>
				</div>
				<div class="clearfix colelem" id="pu7517">
					<!-- group -->
					<a class="nonblock nontext clip_frame grpelem" id="u7517" href="lambai.php?id=<?php echo $id ?>#u8249">
						<!-- image --><img class="block" id="u7517_img" src="images/home-vector%20smart%20objectc10.png?crc=20802956" alt="" width="193" height="49"/>
					</a>
					<a class="nonblock nontext clearfix grpelem" id="u7531-4" href="lambai.php?id=<?php echo $id ?>#u8249">
						<!-- content -->
						<p>Bắt đầu làm bài</p>
					</a>
				</div>
		...
		<div class="verticalspacer" data-offset-top="596" data-content-above-spacer="596" data-content-below-spacer="240"></div>
	...
	<script type="text/javascript">
		...
		var muse_init = function () {
			...
			require( [ "jquery", "museutils", "whatinput", "webpro", "musewpslideshow", "jquery.museoverlay", "touchswipe", "jquery.watch", "jquery.musemenu" ], function ( c ) {
				var $ = c;
